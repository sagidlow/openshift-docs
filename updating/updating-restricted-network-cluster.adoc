...
Before you can upgrade {op-system-first} nodes, you must upgrade the RHCOS cluster. You can use the following procedures to upgrade the RHCOS cluster and then the {op-system-first} worker nodes.
